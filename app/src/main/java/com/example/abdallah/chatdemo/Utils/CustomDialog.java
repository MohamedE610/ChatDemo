...
public class CustomDialog extends Dialog implements
    ...
    final String facebookPageID = "GlobalMediaServicesGms";
    final String youtubeChannel = "https://www.youtube.com/channel/UCdI8evszfZvyAl2UVCypkTA";
    final String gmailStr = "";
    final String phoneNumber = "";
    final String emailStr = "";
    final String locationStr = "";
    final String websiteStr = "http://gmsproduction.com/";
...
// Create the AlertDialog
    ...
    private void phoneCall(String data) {
        ...
        Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:" + "01027620565"));
