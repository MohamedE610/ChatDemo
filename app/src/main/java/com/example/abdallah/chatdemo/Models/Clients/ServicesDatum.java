...
public class ServicesDatum implements Parcelable
{
    ...
    private String logo;
    public final static Creator<ServicesDatum> CREATOR = new Creator<ServicesDatum>() {


        @SuppressWarnings({
            "unchecked"
        })
        public ServicesDatum createFromParcel(Parcel in) {
            return new ServicesDatum(in);
        }

        public ServicesDatum[] newArray(int size) {
            return (new ServicesDatum[size]);
        }

    }
    ;

    protected ServicesDatum(Parcel in) {
     ...
     * @param arDescription
     */
    public ServicesDatum(Integer id, String arName, String enName, String arDescription, String enDescription, String logo) {
        super();
        this.id = id;
        this.arName = arName;
        this.enName = enName;
